...
export async function sendFriendRequest(req, res) {
  try {
    ...
    const { id: recipientId } = req.params; // i can change :id variable name like this
    ...
    /**
     * @description check they are already friends or not in freinds collection
     */
...
export async function getFriendRequests(req,res) {
  try {
    ...
    /**
     * @description get all accepted incoming requests
     */
    ...
    console.error("Erron in getFriendRequests controller", error.message)
    res.status(500).json({
      message: "Internal Server Error!"
    })
  }
